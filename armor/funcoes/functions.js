...
const banner2 = cfonts.render((`Canal: https://youtube.com/@TioModz-kz6iy?si=17bvSMsCpQHUvUTK\nDesenvolvedor Oficial: @editor_profissional_2024`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`VIP 1.0`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
